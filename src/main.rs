...
const ANNE: () = {
    ...
    fn init() {
        ...
        let dma = device.DMA1.dma(&mut rcc);
        let gpioa = device.GPIOA.split();
        let gpiob = device.GPIOB.split();
        // let gpioc = device.GPIOC.split();

        let _row_pins = (
            gpiob.pb9.into_pull_down_input(),
            gpiob.pb8.into_pull_down_input(),
            gpiob.pb7.into_pull_down_input(),
        ...
        let _column_pins = (
            gpioa.pa5.into_push_pull_output().set_pull_up(),
            ...
            gpiob.pb4.into_push_pull_output().pull_up(),
            gpiob.pb5.into_push_pull_output().set_pull_up(),
        );

        core.SCB.system_reset();
